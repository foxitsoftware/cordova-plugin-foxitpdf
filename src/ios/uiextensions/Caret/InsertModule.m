...
-(void)loadModule
{
    _pdfReader.moreToolsBar.insertClicked = ^(){
...
-(void)annotItemClicked
{
    ...
    [Utility showAnnotationType:NSLocalizedStringFromTable(@"kInsertText", @"FoxitLocalizable", nil) type:e_annotCaret pdfViewCtrl:_pdfViewCtrl  belowSubview:_pdfReader.toolSetBar.contentView];
