...
-(void)loadModule
{
    _pdfReader.moreToolsBar.pencileClicked = ^(){
    ...
    [_pdfReader.editBar addItem:pencilItem displayPosition:DEVICE_iPHONE?Position_RB:Position_CENTER];
...
-(void)annotItemClicked
{
    ...
    [Utility showAnnotationType:NSLocalizedStringFromTable(@"kPencil", @"FoxitLocalizable", nil) type:e_annotInk pdfViewCtrl:_pdfViewCtrl belowSubview:_pdfReader.toolSetBar.contentView];
