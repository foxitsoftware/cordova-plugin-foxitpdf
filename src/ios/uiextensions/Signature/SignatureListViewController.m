...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.editItem = [TbBaseItem createItemWithImageAndTitle:NSLocalizedStringFromTable(@"kEdit", @"FoxitLocalizable", nil) imageNormal:[UIImage imageNamed:@"signEdit"] imageSelected:[UIImage imageNamed:@"signEdit"] imageDisable:[UIImage imageNamed:@"signEdit"] background:nil imageTextRelation:RELATION_BOTTOM];
        ...
        self.deleteItem = [TbBaseItem createItemWithImageAndTitle:NSLocalizedStringFromTable(@"kDelete", @"FoxitLocalizable", nil) imageNormal:[UIImage imageNamed:@"signDelete"] imageSelected:[UIImage imageNamed:@"signDelete"] imageDisable:[UIImage imageNamed:@"signDelete"] background:nil imageTextRelation:RELATION_BOTTOM];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    TbBaseItem *titleItem = [TbBaseItem createItemWithTitle:NSLocalizedStringFromTable(@"kSignatureTitle", @"FoxitLocalizable", nil)];
    ...
    __weak typeof(self) weakSelf = self;
    self.createItem = [TbBaseItem createItemWithTitle:NSLocalizedStringFromTable(@"kCreate", @"FoxitLocalizable", nil)];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if (section == DIGITALSIGNATUREGROUP) {
        label.text = NSLocalizedStringFromTable(@"kSignListSectionHadCert", @"FoxitLocalizable", nil);
    }else{
        label.text = NSLocalizedStringFromTable(@"kSignListSectionWithoutCert", @"FoxitLocalizable", nil);
    }
