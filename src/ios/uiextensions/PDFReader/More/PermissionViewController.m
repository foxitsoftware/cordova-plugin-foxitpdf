...
- (void)viewDidLoad
{
    ...
    if (self.navigationItem.titleView != nil)
    {
        ...
        if (titleLabel)
        {
            titleLabel.text = NSLocalizedStringFromTable(@"kPermission", @"FoxitLocalizable", nil);
        }
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        case 0:
            permission.text = NSLocalizedStringFromTable(@"kPermissionPrint", @"FoxitLocalizable", nil);
            if (self.allowPrint) {
                allow.text = NSLocalizedStringFromTable(@"kEnable", @"FoxitLocalizable", nil);
            }
            else
            {
                allow.text = NSLocalizedStringFromTable(@"kDisable", @"FoxitLocalizable", nil);
            }
            break;
        case 1:
            permission.text = NSLocalizedStringFromTable(@"kRMSFILLFORM", @"FoxitLocalizable", nil);
            ...
            break;
        case 2:
            permission.text = NSLocalizedStringFromTable(@"kRMSASSEMBLE", @"FoxitLocalizable", nil);
            ...
            break;
        case 3:
            permission.text = NSLocalizedStringFromTable(@"kRMSANNOTATE", @"FoxitLocalizable", nil);
            ...
            break;
        case 4:
            permission.text = NSLocalizedStringFromTable(@"kRMSEDIT", @"FoxitLocalizable", nil);
            if (self.allowEdit) {
                allow.text = NSLocalizedStringFromTable(@"kEnable", @"FoxitLocalizable", nil);
            }
            else
            ...
            break;
        case 5:
            permission.text = NSLocalizedStringFromTable(@"kRMSEXTRACTACCESS", @"FoxitLocalizable", nil);
            ...
            break;
        case 6:
            permission.text = NSLocalizedStringFromTable(@"kRMSEXTRACT", @"FoxitLocalizable", nil);
