...
- (instancetype)initWithPDFViewCtrl:(FSPDFViewCtrl*)pdfViewCtrl moreSettingBarController:(SettingBarController*)moreSettingBarController pdfReader:(FSPDFReader*)pdfReader
{
    self = [super init];
    if (self) {
        ...
        [self.singleView_iphone setTitle:NSLocalizedStringFromTable(@"kViewModeSingle", @"FoxitLocalizable", nil) forState:UIControlStateNormal];
        ...
        [self.continueView_iphone setTitle:NSLocalizedStringFromTable(@"kViewModeContinuous", @"FoxitLocalizable", nil) forState:UIControlStateNormal];
        ...
        if(self.pdfReader.extensionsMgr.modulesConfig.loadThumbnail)
        {
            ...
            [self.thumbnailView_iphone setTitle:NSLocalizedStringFromTable(@"kViewModeThumbnail", @"FoxitLocalizable", nil) forState:UIControlStateNormal];
        ...
        self.singleView_ipad = [SettingBar createItemWithImageAndTitle:NSLocalizedStringFromTable(@"kViewModeSingle", @"FoxitLocalizable", nil) imageNormal:[UIImage imageNamed:@"readview_single_normal"] imageSelected:[UIImage imageNamed:@"readview_single_selected"] imageDisable:[UIImage imageNamed:@"readview_single_selected"]];
        [self.singleView_ipad addTarget:self action:@selector(singleClicked) forControlEvents:UIControlEventTouchUpInside];
        
        
        self.continueView_ipad = [SettingBar createItemWithImageAndTitle:NSLocalizedStringFromTable(@"kViewModeContinuous", @"FoxitLocalizable", nil) imageNormal:[UIImage imageNamed:@"readview_continue_normal"] imageSelected:[UIImage imageNamed:@"readview_continue_selected"] imageDisable:[UIImage imageNamed:@"readview_continue_selected"]];
        [self.continueView_ipad addTarget:self action:@selector(continueClicked) forControlEvents:UIControlEventTouchUpInside];
        
        self.doubleView_ipad = [SettingBar createItemWithImageAndTitle:NSLocalizedStringFromTable(@"kViewModeTwo", @"FoxitLocalizable", nil) imageNormal:[UIImage imageNamed:@"readview_double_normal"] imageSelected:[UIImage imageNamed:@"readview_double_selected"] imageDisable:[UIImage imageNamed:@"readview_double_selected"]];
        [self.doubleView_ipad addTarget:self action:@selector(doubleClicked) forControlEvents:UIControlEventTouchUpInside];
        
        if(self.pdfReader.extensionsMgr.modulesConfig.loadThumbnail)
        {
            self.thumbnailView_ipad = [SettingBar createItemWithImageAndTitle:NSLocalizedStringFromTable(@"kViewModeThumbnail", @"FoxitLocalizable", nil) imageNormal:[UIImage imageNamed:@"readview_thumail_normal"] imageSelected:[UIImage imageNamed:@"readview_thumail_selected"] imageDisable:[UIImage imageNamed:@"readview_thumail_selected"]];
            [self.thumbnailView_ipad addTarget:self action:@selector(thumbnailClicked) forControlEvents:UIControlEventTouchUpInside];
        }
        
        self.reflowBtn = [SettingBar createItemWithImageAndTitle:NSLocalizedStringFromTable(@"kReflow", @"FoxitLocalizable", nil) imageNormal:[UIImage imageNamed:@"readview_reflow_normal"] imageSelected:[UIImage imageNamed:@"readview_reflow_selected"] imageDisable:[UIImage imageNamed:@"readview_reflow_selected"]];
        [self.reflowBtn addTarget:self action:@selector(reflowClicked) forControlEvents:UIControlEventTouchUpInside];
        
        self.cropBtn = [SettingBar createItemWithImageAndTitle:NSLocalizedStringFromTable(@"kCropMode", @"FoxitLocalizable", nil) imageNormal:[UIImage imageNamed:@"readview_crop_normal"] imageSelected:[UIImage imageNamed:@"readview_crop_selected"] imageDisable:[UIImage imageNamed:@"readview_crop_selected"]];
        [self.cropBtn addTarget:self action:@selector(cropClicked) forControlEvents:UIControlEventTouchUpInside];
        
        self.screenLockBtn = [SettingBar createItemWithImageAndTitle:NSLocalizedStringFromTable(@"kScreenLock", @"FoxitLocalizable", nil) imageNormal:[UIImage imageNamed:@"readview_screen_lock_normal"] imageSelected:[UIImage imageNamed:@"readview_screen_lock_selected"] imageDisable:[UIImage imageNamed:@"readview_screen_lock_selected"]];
        ...
        if (!DEVICE_iPHONE) {
            ...
            self.cropBtn.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
        ...
        if (DEVICE_iPHONE) {
            if(self.pdfReader.extensionsMgr.modulesConfig.loadThumbnail)
            {
                ...
                float viewModeWidth = (SCREENWIDTH - 15*4)/2;
                self.singleView_iphone.frame = CGRectMake(20, 10, viewModeWidth, 30);
                self.continueView_iphone.frame = CGRectMake(25 + viewModeWidth + 15, 10, viewModeWidth, 30);
                [self.contentView addSubview:self.singleView_iphone];
                [self.contentView addSubview:self.continueView_iphone];
            }
            ...
            if ([UIApplication sharedApplication].statusBarOrientation == UIInterfaceOrientationLandscapeLeft || [UIApplication sharedApplication].statusBarOrientation == UIInterfaceOrientationLandscapeRight) {
                ...
                tempWidth += self.screenLockBtn.frame.size.width + spaceWidth;
                self.cropBtn.frame = CGRectMake(20 + tempWidth, 180, self.cropBtn.frame.size.width, self.cropBtn.frame.size.height);
                self.cropBtn.center = CGPointMake((SCREENWIDTH-20)/12*5, self.cropBtn.center.y);

                [self.contentView addSubview:self.reflowBtn];
                [self.contentView addSubview:self.screenLockBtn];
                [self.contentView addSubview:self.cropBtn];
            }
            else
            {
                float spaceWidth = 44;
                ...
                tempWidth += self.screenLockBtn.frame.size.width + spaceWidth;
                self.cropBtn.frame = CGRectMake(20 + tempWidth, 5, self.cropBtn.frame.size.width, self.cropBtn.frame.size.height);
                self.cropBtn.center = CGPointMake((scrollWidth-20)/12*5, self.cropBtn.center.y);
        ...
        else
        {
            ...
            if ([UIApplication sharedApplication].statusBarOrientation == UIInterfaceOrientationLandscapeLeft || [UIApplication sharedApplication].statusBarOrientation == UIInterfaceOrientationLandscapeRight) {
                ...
                if(self.pdfReader.extensionsMgr.modulesConfig.loadThumbnail)
                {
                    ...
                    self.thumbnailView_ipad.center = CGPointMake(10 + (SCREENWIDTH - 20)/20 * index, self.thumbnailView_ipad.center.y);
                ...
                self.reflowBtn.center = CGPointMake(10 + (SCREENWIDTH - 20)/20 * index, self.reflowBtn.center.y);
                ...
                self.screenLockBtn.center = CGPointMake(10 + (SCREENWIDTH - 20)/20 * index, self.screenLockBtn.center.y);
                
                index += 2;
                tempWidth += self.screenLockBtn.frame.size.width + spaceWidth;
                self.cropBtn.frame = CGRectMake(20 + tempWidth, 20, self.cropBtn.frame.size.width, self.cropBtn.frame.size.height);
                self.cropBtn.center = CGPointMake(10 + (SCREENWIDTH - 20)/20 * index, self.cropBtn.center.y);
                ...
                {
                    self.thumbnailView_ipad.frame = CGRectMake(20 + tempWidth, 20, self.thumbnailView_ipad.frame.size.width, self.thumbnailView_ipad.frame.size.height);
                    self.thumbnailView_ipad.center = CGPointMake(10 + (scrollWidth - 20)/20 * index, self.thumbnailView_ipad.center.y);
                    
                    index += 2;
                    tempWidth += self.thumbnailView_ipad.frame.size.width + spaceWidth;
                }
                self.reflowBtn.frame = CGRectMake(20 + tempWidth, 20, self.reflowBtn.frame.size.width, self.reflowBtn.frame.size.height);
                self.reflowBtn.center = CGPointMake(10 + (scrollWidth - 20)/20 * index, self.reflowBtn.center.y);
                
                index += 2;
                tempWidth += self.reflowBtn.frame.size.width + spaceWidth;
                self.screenLockBtn.frame = CGRectMake(20 + tempWidth, 20, self.screenLockBtn.frame.size.width, self.screenLockBtn.frame.size.height);
                self.screenLockBtn.center = CGPointMake(10 + (scrollWidth - 20)/20 * index, self.screenLockBtn.center.y);
                
                index += 2;
                tempWidth += self.screenLockBtn.frame.size.width + spaceWidth;
                self.cropBtn.frame = CGRectMake(20 + tempWidth, 20, self.cropBtn.frame.size.width, self.cropBtn.frame.size.height);
                self.cropBtn.center = CGPointMake(10 + (scrollWidth - 20)/20 * index, self.cropBtn.center.y);
        ...
        CGSize titleSize  = [Utility getTextSize:NSLocalizedStringFromTable(@"kAutoBrightness", @"FoxitLocalizable", nil) fontSize:15.0f maxSize:CGSizeMake(200, 100)];
        ...
        self.brightnessLabel.text = NSLocalizedStringFromTable(@"kAutoBrightness", @"FoxitLocalizable", nil);
...
-(void)initValuesAndActions
{
    ...
    self.thumbnail = ^ (BOOL selected) {
        [weakSelf.pdfReader.extensionsMgr showThumbnailView];
        weakSelf.moreSettingBarController.hiddenSettingBar = YES;
    };
    ...
    self.lockscreen = ^ (BOOL selected) {
        ...
        weakSelf.pdfReader.isScreenLocked = weakSelf.isScreenLocked;
    };
...
{
    if (self.cropage) {
        self.cropage(self.cropBtn.selected);
    }
}
...
- (void)orientationChanged:(NSNotification *)note  {
    ...
    if (DEVICE_iPHONE) {
        if (o == UIDeviceOrientationLandscapeLeft || o == UIDeviceOrientationLandscapeRight) {
            ...
            [self.cropBtn removeFromSuperview];
            ...
            tempWidth += self.screenLockBtn.frame.size.width + spaceWidth;
            self.cropBtn.frame = CGRectMake(20 + tempWidth, 180, self.cropBtn.frame.size.width, self.cropBtn.frame.size.height);
            self.cropBtn.center = CGPointMake((a-20)/12*5, self.cropBtn.center.y);
