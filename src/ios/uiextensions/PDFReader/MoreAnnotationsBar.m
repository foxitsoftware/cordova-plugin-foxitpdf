...
-(MoreAnnotationsBar*)init:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.textLabel.text = NSLocalizedStringFromTable(@"kMoreTextMarkup", @"FoxitLocalizable", nil);
        ...
        self.drawLabel.text = NSLocalizedStringFromTable(@"kMoreDrawing", @"FoxitLocalizable", nil);
        ...
        self.othersLabel.text = NSLocalizedStringFromTable(@"kMoreOthers", @"FoxitLocalizable", nil);
        ...
        self.typewriterBtn = [MoreAnnotationsBar createItemWithImageAndTitle:NSLocalizedStringFromTable(@"kTypewriter", @"FoxitLocalizable", nil) imageNormal:typeriterImage];
        self.noteBtn = [MoreAnnotationsBar createItemWithImageAndTitle:NSLocalizedStringFromTable(@"kNote", @"FoxitLocalizable", nil) imageNormal:noteImage];
        self.attachmentBtn = [MoreAnnotationsBar createItemWithImageAndTitle:NSLocalizedStringFromTable(@"kAttachment", @"FoxitLocalizable", nil) imageNormal:attachmentImage];
        self.stampBtn = [MoreAnnotationsBar createItemWithImageAndTitle:NSLocalizedStringFromTable(@"kPropertyStamps", @"FoxitLocalizable", nil) imageNormal:stampImage];
...
- (void)refreshAnnotationBarLayout
{
    ...
    CGRect frame = DEVICE_iPHONE ? CGRectMake(0, screenFrame.size.height-250, screenFrame.size.width, 250) : CGRectMake(0, 0, 300, 250);
