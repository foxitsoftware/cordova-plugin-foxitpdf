...
- (instancetype)initWithUIExtensionsManager:(UIExtensionsManager *)extensionsManager {
    ...
    if (self) {
        ...
        DistanceToolHandler* toolHandler = [[DistanceToolHandler alloc] initWithUIExtensionsManager:extensionsManager];
...
- (void)annotItemClicked {
    ...
    [Utility showAnnotationType:FSLocalizedString(@"kDistance") type:e_annotLine pdfViewCtrl:_extensionsManager.pdfViewCtrl belowSubview:_extensionsManager.toolSetBar.contentView];
